<?php
/**
 * THIS PAGE LOAD THE 100 TOP WATCHED FILMS
 */
...
$query = "SELECT DISTINCT nome, visioni,link,locandina,imdb,anno FROM Altadefinizione WHERE visioni > 0 ORDER BY `Altadefinizione`.`visioni` DESC LIMIT 100" ;
$result = mysql_query($query) or die("QUERY FALLITA");
$i = 0;
?>

<head>
  <title>Top Film Guardati</title>
...
<div id='divAlto'> <a href='#'><img src='img/topguardati.jpg'></a> </div>
